...
dg_scene_t *scene_escape_menu(void)
{
    ...
    dg_scene_add_ent(scene, ent_button
        ((sfVector2f){800, 400}, 100, "Resume", &go_to_resume));
    dg_scene_add_ent(scene, ent_button
        ((sfVector2f){800, 500}, 100, "Reload", &go_to_reload));
    dg_scene_add_ent(scene, ent_button
        ((sfVector2f){800, 600}, 100, "Quit to menu", &go_to_menu));
    dg_scene_add_ent(scene, ent_button
        ((sfVector2f){800, 700}, 100, "Quit Game", &go_to_quit));
